    ...
    <div class="flex min-h-screen">
        ...
        <aside class="admin-sidebar lg:fixed lg:inset-y-0 lg:left-0 lg:w-64">
            ...
            <nav class="space-y-0.5">
                ...
                <p class="px-2 pb-1 text-[0.65rem] font-semibold uppercase tracking-widest" style="color:var(--ink-muted)">Kelola Halaman Pengguna</p>
                ...
                {{-- Kontak --}}
                <a href="{{ route('admin.contact') }}" wire:navigate wire:current="admin-nav-link-active"
                    class="admin-nav-link">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
